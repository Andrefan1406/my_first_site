...
const znbBrandOptions = {
    ...
    'Блоки бетонные для стен подвалов': ['ФБС 12.4.6т', 'ФБС 12.5.6т', 'ФБС 24.4.6т', 'ФБС 24.5.6т',
        'ФБС 24.6.6т', 'ФБС 9.4.6т', 'ФБС 9.5.6т', 'ФБС 9.6.6т', 'ФБС12.6.6т', 'другое'],
    ...
    'Кольцо стеновое цилиндрическое (Технологический бетон)': ['КС 10-3', 'КС 10-6 ', 'КС 10-9 ', 'КС 15-6',
        'КС 15-9', 'КС 20-6', 'КС 20-9', 'КС 7-3', 'КС 7-9', 'другое'],
    ...
    'Перемычка брусковая': ['1ПБ 13-1п', '1ПБ 16-1п', '2ПБ 10-1п', '2ПБ 13-1п', '2ПБ 16-2п', '2ПБ 17-2п',
        ...
        '4ПБ 44-8п', '5ПБ 18-27п', '5ПБ 21-27п', '5ПБ 25-27п', '5ПБ 27-27п', '5ПБ 27-37п', 'другое'],
    'Плита': ['ОП 200', 'ОП 220', 'П11-8', 'П-4', 'ПД 300.150.14-9', 'ПД 300.240.20-9', 'ПД 300.300.20-9',
        ...
        'ПТ 75.210.16-9', 'ПТ 75.300.25-9', 'ПТ40-12', 'ПТ40-15', 'другое'],
    ...
    'Плита перекрытия': ['КЦП 2-7', '1ПП15-1', '1ПП15-2', '1ПП20-1', '1ПП20-2', 'ПП10-1', 'ПП10-2', 'другое'],
...
const seriesBrandOptions = {
    ...
    'серия 1.038.1-1 вып.2': ['2ПП17-5', '2ПП18-5', '3ПП16-71', '3ПП18-71', '3ПП27-71', '6ПП16-72', '6ПП21-72', '6ПП27-72', '6ПП30-13'],
    'серия 3.006.1-2.87': ['ПО-2', 'ПО-3', 'ПО-4'],
    'серия 3.900.1-4 в.1 (c.3.900-3 в.7)': ['КС 10.3 (КЦ-10-3)', 'КС 10.6 (КЦ-10-6)', 'КС 10.9 (КЦ-10-9)', 'КС 15.6 (КЦ-15-6)', 
        'КС 15.9 (КЦ-15-9)', 'КС 20.6 (КЦ-20-6)', 'КС 20.9 (КЦ-20-9)', 'КС 7.3 (КЦ-7-3)', 'КС 7.9 (КЦ-7-9)', 'КО-6 (КЦО-1)'],
    'серия 3.900.1-4 в.1 (c.3.900-3 в.7) ': ['ПН10 (КЦД-10)', 'ПН15 (КЦД-15)', 'ПН20 (КЦД-20)', 'ПН7 (КЦД-7)', 
      '1ПП15-1 (КЦП1-15-1)', '1ПП15-2 (КЦП1-15-2)', '1ПП20-1 (КЦП1-20-1)', '1ПП20-2 (КЦП1-20-1)', 
      'ПП10-1 (КЦП1-10-1)', 'ПП10-2 (КЦП1-10-2)']
};
