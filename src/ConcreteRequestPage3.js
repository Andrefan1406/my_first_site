...
const ConcreteRequestPage3 = () => {
  ...
  try {
    await fetch('https://script.google.com/macros/s/AKfycbwK-H5SG61iLP5Ixom-WEmZC1iAiRmfBkSDk5wdzQrGov3HTH6bdisLPKc1Sa_F9wPKiQ/exec', {
      method: 'POST',
      mode: 'no-cors',
...
export default ConcreteRequestPage3;
