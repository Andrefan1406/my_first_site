...
import styles from './RequestPage.module_v2.css';
...
const objectCategoryOptions = {
  "Строительство жилых домов": ["Брик таун 2", "НЖ 3", "СПОРТ 2", "Элитка"],
...
const objectPositionOptions = {
  "Брик таун 2": ["Пятно 1", "Пятно 2", "Пятно 3"]
...
const positionBlockOptions = {
  "Пятно 1": ["блок 1.3","блок 2.1", "блок 2.2", "блок 2.3"],
  "Пятно 2": ["блок 1.1","блок 1.2", "блок 2.1", "блок 2.3"],
  "Пятно 3": ["блок 3.1","блок 3.2", "блок 3.3"],
  "поз.56": ["поз.56", "поз. 57", "поз. 58", "поз. 59", "поз.60", "поз. 63", "поз. 64", "поз. 65", "поз. 69", "поз. 72", "Стройгородок НЖ3", "Экополис поз.103", "Экополис поз.104", "Экополис паркинг поз.105"],
  "поз.57": ["поз.56", "поз. 57", "поз. 58", "поз. 59", "поз.60", "поз. 63", "поз. 64", "поз. 65", "поз. 69", "поз. 72", "Стройгородок НЖ3", "Экополис поз.103", "Экополис поз.104", "Экополис паркинг поз.105"],
  "поз.58": ["поз.56", "поз. 57", "поз. 58", "поз. 59", "поз.60", "поз. 63", "поз. 64", "поз. 65", "поз. 69", "поз. 72", "Стройгородок НЖ3", "Экополис поз.103", "Экополис поз.104", "Экополис паркинг поз.105"],
  "поз.59": ["поз.56", "поз. 57", "поз. 58", "поз. 59", "поз.60", "поз. 63", "поз. 64", "поз. 65", "поз. 69", "поз. 72", "Стройгородок НЖ3", "Экополис поз.103", "Экополис поз.104", "Экополис паркинг поз.105"],
  "НЖ 3": ["поз.56", "поз. 57", "поз. 58", "поз. 59", "поз.60", "поз. 63", "поз. 64", "поз. 65", "поз. 69", "поз. 72", "Стройгородок НЖ3", "Экополис поз.103", "Экополис поз.104", "Экополис паркинг поз.105"],
  "НЖ 3": ["поз.56", "поз. 57", "поз. 58", "поз. 59", "поз.60", "поз. 63", "поз. 64", "поз. 65", "поз. 69", "поз. 72", "Стройгородок НЖ3", "Экополис поз.103", "Экополис поз.104", "Экополис паркинг поз.105"],
  "НЖ 3": ["поз.56", "поз. 57", "поз. 58", "поз. 59", "поз.60", "поз. 63", "поз. 64", "поз. 65", "поз. 69", "поз. 72", "Стройгородок НЖ3", "Экополис поз.103", "Экополис поз.104", "Экополис паркинг поз.105"],
  "НЖ 3": ["поз.56", "поз. 57", "поз. 58", "поз. 59", "поз.60", "поз. 63", "поз. 64", "поз. 65", "поз. 69", "поз. 72", "Стройгородок НЖ3", "Экополис поз.103", "Экополис поз.104", "Экополис паркинг поз.105"],
